...
(let (;; theme base colors
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1  ((t (:inherit (outline-1) :height 1.4 :background ,theme-dark))))
   `(org-level-2  ((t (:inherit (outline-2) :height 1.4 :background ,theme-dark))))
   `(org-level-3  ((t (:inherit (outline-3) :height 1.4 :background ,theme-dark))))
   `(org-level-4  ((t (:inherit (outline-4) :height 1.4 :background ,theme-dark))))
   `(org-level-5  ((t (:inherit (outline-5) :height 1.4 :background ,theme-dark))))
   `(org-level-6  ((t (:inherit (outline-6) :height 1.4 :background ,theme-dark))))
   `(org-level-7  ((t (:inherit (outline-7) :height 1.4 :background ,theme-dark))))
   `(org-level-8  ((t (:inherit (outline-8) :height 1.4 :background ,theme-dark))))))
