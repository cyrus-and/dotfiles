...
Show immediately the menu and complete everywhere:
...
(defun my/rgrep-again ()
  (interactive)
  (let* ((buffer (or grep-last-buffer (current-buffer)))
         (default-directory (buffer-local-value 'default-directory buffer)))
    (let ((symbol (or (thing-at-point 'symbol t) (read-string "Regex: "))))
      (if symbol
          (rgrep symbol
...
Use visual line wrapping by default:
